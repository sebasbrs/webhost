...
|--------------------------------------------------------------------------
*/
$config['title'] = "Empire Of Darkness | International WoW";
...
|--------------------------------------------------------------------------
*/
$config['server_name'] = "Empire Of Darkness";
...
|--------------------------------------------------------------------------
*/
$config['realmlist'] = "logon.empireofdarkness.tk";
...
$config['slider_interval'] = 10000;
$config['slider_style'] = "turn";
...
$config['vote_reminder_image'] = "banner.png";
$config['reminder_interval'] = 675000;
...
|
*/
$config['keywords'] = "outlaw rogue, outlaw rogue pvp, world of warcraft, legion, assassination rogue, subtlety rogue, warlords of draenor, rogue gameplay, how to, rogue guide, kick, adrenaline rush, killing spree, kidney shot, skill, montage, pvp guide, build, talents, rogue gaming, rogue pvp, crowd control, rating climbing, 5v5, sub rogue, 2v2, arenas, battlegrounds, player vs player, rogue duels, rogue bg, legion pvp, sub pvp, assassination pvp, rogue arena, 3v3, battle for azeroth, wow, warcraft,";
$config['description'] = "a New International WoW Server Made for Everypeople ( Es, En, Fr, Pr, De & Ru)";
